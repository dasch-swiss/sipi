...
The following URL forms are accepted by the IIIF endpoint and have a working implementation behind them. The list mirrors what `info.json` advertises in its `extraFeatures` and `extraFormats` arrays:
