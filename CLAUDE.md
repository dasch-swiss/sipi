...
- `infra/nativelink/` — OpenTofu for the NativeLink RBE backend (GCE VM: remote cache + executor + `bazel-remote` download cache) + monitoring; see its `README.md` and `RUNBOOK.md`
