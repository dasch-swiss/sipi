...
See [Building: Vendored Dependencies](../building/#vendored-dependencies) for setup instructions and update/add workflows.
...
We use [Conventional Commits](https://www.conventionalcommits.org/). These prefixes drive [release-please](../ci/#release-automation-release-please) to automatically determine SemVer bumps and generate changelogs — **using the correct prefix is required, not optional**.
