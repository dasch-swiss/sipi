...
**Corpus management:** CI uploads corpus artifacts; `just fuzz-corpus-update` merges CI corpus into seed corpus. See [Fuzz Testing](https://sipi.io/development/fuzzing/index.md) for full details.
