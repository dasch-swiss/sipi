...
>
> **The strangler-fig migration this ADR proposed is now complete** — see
> [ADR-0020](0020-oracle-removal.md). The C++ HTTP layer (`src/shttps/` transport
> + `SipiHttpServer`) has been deleted; the Rust shell is the sole production server.
