...
**Monitoring:** SIPI exports its metrics over OTLP, to the endpoint in
`OTEL_EXPORTER_OTLP_ENDPOINT`; there is no `GET /metrics` scrape endpoint. The names below are what
