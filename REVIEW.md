...
- Comments otherwise follow [`.claude/rules/comments.md`](.claude/rules/comments.md). Flag what it deletes: restatements of the line below, history ("previously", "now uses"), roadmap ("not yet wired"), REQ ids and plan-phase references, and a `TODO` with no issue id.
