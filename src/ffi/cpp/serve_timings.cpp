...
// (`server/rust/src/ffi.rs`), held in lock-step with the Rust `offset_of!`/
...
static_assert(sizeof(SipiServeTimings) == 120, "SipiServeTimings size drifted from src/server/rust/src/ffi.rs");
