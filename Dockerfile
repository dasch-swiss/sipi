...
RUN if [ "$TARGETPLATFORM" = "linux/amd64" ]; then \
        curl https://github.com/fpco/pid1-rs/releases/download/v0.1.2/pid1-x86_64-unknown-linux-musl --output /usr/sbin/pid1 && chmod +x /usr/sbin/pid1; \
    elif [ "$TARGETPLATFORM" = "linux/arm64" ]; then \
        curl https://github.com/fpco/pid1-rs/releases/download/v0.1.2/pid1-aarch64-unknown-linux-musl --output /usr/sbin/pid1 && chmod +x /usr/sbin/pid1; \
    else \
